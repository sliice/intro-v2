...
export const AddTest = () => {
    ...
    const questionIsChecked = isChecked => {
        return classNames({questionIsNotChecked: !isChecked, questionIsChecked: isChecked})
    }
    ...
    useEffect(() => {
        ...
        document.title = 'Добавить методику'
    }, [])
    ...
    return (
        <div className = 'addingTest'>
            ...
            <div className = 'addingTestModule'>
                <h2>Шкалы</h2>
                <div className = 'addingTestModule'>
                    <p className = 'scaleIntervalsP'>Шкальные интервалы – это балльные промежутки, которые могут характеризовать,
